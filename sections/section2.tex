...
No intuito de obter uma Hessiana semi-definida positiva, ou seja, no caso onde não há singularidade, deve-se obter valores de que respeitem a seguinte condição: 
{\centering\\$det(H)\geq 0$.\\}
