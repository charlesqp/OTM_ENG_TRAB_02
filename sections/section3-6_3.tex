...
\pgfplotstableread{data/sec1s1tbl19_DFP_raw.txt}{\tblCDFP}
\pgfplotstableread{data/sec1s1tbl19_BFGS_raw.txt}{\tblCBFGS}
\pgfplotstableread{data/sec1s1tbl19_Huang_raw.txt}{\tblCHuang}
\pgfplotstableread{data/sec1s1tbl19_Biggs_raw.txt}{\tblCBiggs}
