         ...
         \begin{figure}[h!]            
            ...
            \subfloat[\centering label 1]{{
                \begin{tikzpicture}
                    \begin{axis}[%
                    scatter/classes={%
                    DFP={mark=o,draw=black},BFGS={mark=o,draw=blue}}]
                        \addplot[scatter,only marks,scatter src=explicit]table[x=spl,y=Erro_Xsol_P,meta=Metodo]{\tblADFP};
                        \addplot[scatter,only marks,scatter src=explicit]table[x=spl,y=Erro_Xsol_P,meta=Metodo]{\tblABFGS};
                    \end{axis}                     
                \end{tikzpicture} 
                }}%              
            \caption{2 Figures side by side}%
