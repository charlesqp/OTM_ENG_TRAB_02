...
\pgfplotstableread{data/sec1s1tbl20_DFP_raw.txt}{\tblDDFP}
\pgfplotstableread{data/sec1s1tbl20_BFGS_raw.txt}{\tblDBFGS}
\pgfplotstableread{data/sec1s1tbl20_Huang_raw.txt}{\tblDHuang}
\pgfplotstableread{data/sec1s1tbl20_Biggs_raw.txt}{\tblDBiggs}
